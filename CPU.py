...
def printRow(id, arrivalTime, burstTime, CT, TAT, WaitingTime):
    print("=" * 30)
    print("ID = " + str(id) + "|" + "Arrival Time = " + str(arrivalTime) + "|" + "Burst Time = " + str(
        burstTime) + "|" + "Completion Time = " + str(CT) + "|" + "Turnaround Time = " + str(
        TAT) + "|" + "Waiting Time = " + str(WaitingTime))
    print("=" * 30)
...
def printTable(rows):
    ...
    while i < len(rows):
        printRow(rows[i]["id"], rows[i]["arrivalTime"], rows[i]["burstTime"], rows[i]["completionTime"],
                 rows[i]["turnaroundTime"], rows[i]["waitingTime"])
